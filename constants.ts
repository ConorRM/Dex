import { GenListEntry } from "./types";

export const WOTC_BASE_MAP: { [key: number]: number } = {
...
export const RAW_POKEMON: (string | { name: string; cardImage: string })[] = [
...
export const GEN_2_POKEMON: GenListEntry[] = [
...
export const GEN_3_POKEMON: GenListEntry[] = [
